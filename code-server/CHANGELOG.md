# Changelog since v8.0.6
- Merge pull request #199 from elcajon/dependabot/github_actions/docker/setup-qemu-action-2.0.0

Bump docker/setup-qemu-action from 1.2.0 to 2.0.0 
- Merge pull request #198 from elcajon/dependabot/github_actions/docker/setup-buildx-action-2.0.0

Bump docker/setup-buildx-action from 1.7.0 to 2.0.0 
- Merge pull request #197 from elcajon/dependabot/github_actions/docker/build-push-action-3.0.0

Bump docker/build-push-action from 2.10.0 to 3.0.0 
- Merge pull request #196 from elcajon/dependabot/github_actions/docker/login-action-2.0.0
