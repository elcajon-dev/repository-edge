...
- Merge pull request #25 from elcajon/dependabot/github_actions/docker/login-action-2.0.0

Bump docker/login-action from 1.14.1 to 2.0.0 
- Merge branch 'main' into dependabot/github_actions/docker/login-action-2.0.0 
- Merge pull request #26 from elcajon/dependabot/github_actions/docker/setup-buildx-action-2.0.0
...
- Merge pull request #24 from elcajon/dependabot/github_actions/docker/setup-qemu-action-2.0.0
...
- Merge pull request #23 from elcajon/dependabot/github_actions/docker/build-push-action-3.0.0
